    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <span className="text-primary text-sm font-mono font-medium tracking-wider uppercase">
            08. Contact
          </span>
        </motion.div>
        <motion.h2
        ...
        >
          Have a project, idea, or opportunity? I'd love to hear from you let's
        ...
        <div className="grid lg:grid-cols-5 gap-10 lg:gap-14">
          ...
          >
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2">
                {[
                  ...
                  // { Icon: SiUpwork, label: "Upwork", href: PERSONAL.upwork, color: "oklch(0.70 0.22 145)" },
                  {
                    Icon: SiWhatsapp,
                    label: "WhatsApp",
            ...
            */}
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 px-5 py-3 rounded-xl border border-green-500/30 bg-green-500/10 text-white-1000 hover:bg-green-500/20 transition-all font-medium text-sm"
            >
              <SiUpwork className="w-5 h-5" /> Hire me on Upwork
            </a>
          </motion.div>
          ...
          >
            <form
              ...
              className="p-6 sm:p-8 rounded-2xl border border-border/50 bg-card/50 space-y-5"
            ...
            >
              ...
              {status === "success" && (
                <motion.div
                  ...
                  className="flex items-center gap-3 px-4 py-3 rounded-xl bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-sm"
                >
              ...
              {status === "error" && (
                ...
                >
                  <AlertCircle className="w-4 h-4 shrink-0" /> Something went
